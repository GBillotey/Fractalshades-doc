...
.. "examples/batch_mode/10-double_embedded_julia.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_batch_mode_10-double_embedded_julia.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_batch_mode_10-double_embedded_julia.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 24-159



.. image-sg:: /examples/batch_mode/images/sphx_glr_10-double_embedded_julia_001.png
   :alt: 10 double embedded julia
   :srcset: /examples/batch_mode/images/sphx_glr_10-double_embedded_julia_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  39.798 seconds)


.. _sphx_glr_download_examples_batch_mode_10-double_embedded_julia.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-python
      ...
      :download:`Download Python source code: 10-double_embedded_julia.py <10-double_embedded_julia.py>`

    .. container:: sphx-glr-download sphx-glr-download-jupyter

      :download:`Download Jupyter notebook: 10-double_embedded_julia.ipynb <10-double_embedded_julia.ipynb>`
