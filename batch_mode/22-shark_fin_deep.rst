...
.. "examples/batch_mode/22-shark_fin_deep.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_batch_mode_22-shark_fin_deep.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_batch_mode_22-shark_fin_deep.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 15-278



.. image-sg:: /examples/batch_mode/images/sphx_glr_22-shark_fin_deep_001.png
   :alt: 22 shark fin deep
   :srcset: /examples/batch_mode/images/sphx_glr_22-shark_fin_deep_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 4 minutes  54.872 seconds)


.. _sphx_glr_download_examples_batch_mode_22-shark_fin_deep.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: 22-shark_fin_deep.py <22-shark_fin_deep.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: 22-shark_fin_deep.ipynb <22-shark_fin_deep.ipynb>`
