...
.. "examples/batch_mode/21-perpendicular_burning_ship_trees.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_batch_mode_21-perpendicular_burning_ship_trees.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_batch_mode_21-perpendicular_burning_ship_trees.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 13-205



.. image-sg:: /examples/batch_mode/images/sphx_glr_21-perpendicular_burning_ship_trees_001.png
   :alt: 21 perpendicular burning ship trees
   :srcset: /examples/batch_mode/images/sphx_glr_21-perpendicular_burning_ship_trees_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  54.452 seconds)


.. _sphx_glr_download_examples_batch_mode_21-perpendicular_burning_ship_trees.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: 21-perpendicular_burning_ship_trees.py <21-perpendicular_burning_ship_trees.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: 21-perpendicular_burning_ship_trees.ipynb <21-perpendicular_burning_ship_trees.ipynb>`
