...
.. "examples/batch_mode/20-perpendicular_burning_ship_Sierpinski.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_batch_mode_20-perpendicular_burning_ship_Sierpinski.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_batch_mode_20-perpendicular_burning_ship_Sierpinski.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 14-201



.. image-sg:: /examples/batch_mode/images/sphx_glr_20-perpendicular_burning_ship_Sierpinski_001.png
   :alt: 20 perpendicular burning ship Sierpinski
   :srcset: /examples/batch_mode/images/sphx_glr_20-perpendicular_burning_ship_Sierpinski_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 2 minutes  43.652 seconds)


.. _sphx_glr_download_examples_batch_mode_20-perpendicular_burning_ship_Sierpinski.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: 20-perpendicular_burning_ship_Sierpinski.py <20-perpendicular_burning_ship_Sierpinski.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: 20-perpendicular_burning_ship_Sierpinski.ipynb <20-perpendicular_burning_ship_Sierpinski.ipynb>`
